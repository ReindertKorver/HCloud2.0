<%@ Page Title="" Language="C#" MasterPageFile="~/Portal.master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ClientData.aspx.cs" Inherits="HCloud.PortalContent.ClientData" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="FilesTopBar" style="padding-top: 7px;">
        <div class="FilesTopBarItem">
            Gegevens van
            <asp:DropDownList ID="NewUserData" runat="server" Style="display: initial; width: auto;" CssClass="form-control" OnSelectedIndexChanged="NewUserData_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
        </div>
