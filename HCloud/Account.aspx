        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse0">Gebruiker gegevens</a>
                </h4>
            </div>
            <script>
                $(document).ready(function (event) {
                    $("#ProfileCollapse").on("click", function () {
                        ...
                        $("#collapse00").toggleClass("Openpanel");
                        $("#ProfilePicture").toggleClass("OpenPicture");
                    });
                    $("#IMGCover").on("click", function () {
                        $("#<%=ProfileImageUpload.ClientID%>").click();
                    });
                    $(".messagerPF").on("click", function () {
                        $(".messagerPF").fadeOut();
                    });
                    $("#<%=ProfileImageUpload.ClientID%>").innerHTML = "";
                });
            </script>
            ...
            <div id="collapse0" class="panel-collapse collapse in">
                ...
                <div id="messagerPF" class="messagerPF" runat="server" >

    </div>
                <div id="UserDataDiv" class="UserDataControl" style="padding-left: 50px; padding-right: 50px;" runat="server">
                    <asp:FileUpload ID="ProfileImageUpload" runat="server" style="display: none!important; visibility:hidden!important;" AllowMultiple="false" onchange="this.form.submit()" />
                    <div class="panel-group" id="accordion1">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="Profile Open">
                                    <div id="ProfilePicture" class="SmallProfilePicture OpenPicture">
                                        <div class="ProfileImageCover">
                                            <asp:Image ID="ProfileImage" CssClass="ProfileImg" style='height: 100%; width: 100%; object-fit: cover; border: 1px solid #127a7b; border-radius: 100%;position: absolute;' runat="server"/>
                                            <img id="IMGCover" src="Resources/Overlay.png" title="Verander profielfoto" />
                                        </div>
                                    </div>
                                    <h4 class="panel-title" style="margin-top: 15px;">
                                        <a data-toggle="collapse" data-parent="#accordion1" href="#collapse00" id="ProfileCollapse">
                                            <asp:Label ID="UserName" runat="server"></asp:Label>
                                        </a>
                                    </h4>
                                    <div id="collapse00" class="panel-collapse Openpanel collapse in">
                                        <div id="ProfileInformation" runat="server">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion1" href="#collapse10" class="">Persoonsgegevens</a>
                                </h4>
                            </div>
                ...
                Limburg
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion1" href="#collapse11" class="">Zorg metingen</a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion1" href="#collapse12" class="">QR code</a>
                                </h4>
                            </div>
                            <div id="collapse12" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <script type="text/javascript" src="/Scripts/qrcode.js"></script>
                                    <asp:Label ID="BSNNumberQR" runat="server"></asp:Label>
                                    <div id="qrcode"></div>
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            ...
                                            function makeCode() {
                                                qrcode.makeCode(document.getElementById("<%=BSNNumberQR.ClientID%>").innerHTML);
                                            }
                                            makeCode();
                                        });
